...
Original file is located at
    https://colab.research.google.com/drive/1tnOMGDgsfTJbW6uuq5RXGoWRCvinM0Y-
"""
...
def fetch_pdf_links(max_pages=5):
    ...
    for page in range(max_pages):
        ...
        for a in soup.select('a.download-pdf'):  # Adjust selector
            href = a.get('href')
...
# Streamlit UI
st.title("Parliamentary QA Assistant (Agentic AI)")

st.sidebar.header("Configuration")
max_pages = st.sidebar.number_input("Max pages to crawl", min_value=1, max_value=20, value=5)

st.write("This tool answers parliamentary questions based on past ministerial responses.")
...
if st.button("Get Answer"):
    if question.strip() == "" or minister.strip() == "":
        st.error("Please provide both a question and minister name.")
    else:
        prompt = f"You are answering on behalf of {minister}. Provide a formal, solution-oriented answer focused on public interest and welfare. Question: {question}"
